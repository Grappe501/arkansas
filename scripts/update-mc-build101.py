...
mc['executive'] = {
    **{k: v for k, v in prior_ex.items() if k not in (
    ...
    'database_schema_readiness': max(52, prior_ex.get('database_schema_readiness', 44)),
    'component_registry_readiness': max(26, prior_ex.get('component_registry_readiness', 22)),
    'route_inventory_readiness': max(28, prior_ex.get('route_inventory_readiness', 22)),
...
build_entry = {
    ...
    'summary': (
        f"50 steps in 5 bands. IMP-01–04 documented (Constitution, Architecture, Route Map, Database Schema). "
    ...
    'files_modified': [
        'js/mission-control.js', 'data/site.json', 'data/canonical-data-model.json',
    ...
    'decisions_made': [
        ...
        'IMP-03 Route Map: complete navigation before code',
        'IMP-04 Database Schema: canonical data model before migrations',
    ...
    'open_questions': [
        'IMP-05 identity vs repository migration — align step registry with package titles',
...
mc['briefing'] = {
    'what_built': 'IMP-01–04 documented: Constitution, Architecture, Route Map, Database Schema + manifests',
    'building_now': 'IMP-05 Master User Identity, Authentication, Roles & Permissions next',
    'blocked': ['Sprint Zero not complete', '0/50 code-implemented', 'No live Postgres/Prisma migrations yet'],
    'ready_public': [
        'Technical Constitution', 'Technical Architecture', 'Route Map', 'route-manifest.json',
        'Database Schema', 'canonical-data-manifest.json', 'prisma/schema.prisma (draft)',
    ],
    'next': 'IMP-05 — Master User Identity, Authentication, Roles & Permissions',
}
