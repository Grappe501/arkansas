...
async function initCursorImplementationPackage() {
  ...
  root.innerHTML = `
    ...
    <h2 class="mc-section-title">Research Intelligence (IMP-35) — 70% Milestone</h2>
    <p class="mc-bar-note"><strong>${cip.research_intelligence.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.research_intelligence.research_intelligence_division_count} intelligence divisions · ${cip.research_intelligence.civic_issue_observatory_count} civic issue observatories · ${cip.research_intelligence.research_watchlist_item_count} watchlist items · ${cip.research_intelligence.arkansas_civic_indicator_count} civic indicators · ${cip.research_intelligence.research_intelligence_deliverable_count} deliverables · ${cip.research_intelligence.packages_complete_pct}% complete (${cip.research_intelligence.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Arkansas Civic Insights Center:</strong> legal · legislative · community · educational · institutional · historical intelligence · Oct 1 county research profiles statewide</p>
    <p class="mc-bar-note"><a href="${cip.research_intelligence.route}">IMPLEMENTATION_PACKAGE_35_RESEARCH_INTELLIGENCE.md</a> · <a href="${cip.research_intelligence.manifest}">research-intelligence-manifest.json</a> · <a href="${cip.research_intelligence.mc_dashboard}">Research Observatory dashboard</a></p>
    <p class="mc-bar-note">${cip.research_intelligence.philosophy}</p>
    <h2 class="mc-section-title">Executive Cockpit (IMP-34)</h2>
    <p class="mc-bar-note"><strong>${cip.executive_cockpit.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.executive_cockpit.executive_cockpit_component_count} cockpit components · ${cip.executive_cockpit.arkansas_operations_map_indicator_count} operations map indicators · ${cip.executive_cockpit.executive_briefing_item_count} briefing items · ${cip.executive_cockpit.executive_cockpit_deliverable_count} command deliverables · ${cip.executive_cockpit.mc_executive_metric_count} executive metrics · ${cip.executive_cockpit.packages_complete_pct}% complete (${cip.executive_cockpit.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Command environment:</strong> Executive Cockpit · MC Wall · county & organization ops centers · situation room · forecasts · alerts · decision support · Oct 1 statewide visibility</p>
    <p class="mc-bar-note"><a href="${cip.executive_cockpit.route}">IMPLEMENTATION_PACKAGE_34_EXECUTIVE_COCKPIT.md</a> · <a href="${cip.executive_cockpit.manifest}">executive-cockpit-manifest.json</a> · <a href="${cip.executive_cockpit.mc_dashboard}">Executive Command Center</a></p>
    <p class="mc-bar-note">${cip.executive_cockpit.philosophy}</p>
    <h2 class="mc-section-title">Engineering Standards (IMP-33)</h2>
    <p class="mc-bar-note"><strong>${cip.engineering_standards.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.engineering_standards.repository_domain_count} repository domains · ${cip.engineering_standards.coding_standard_count} coding standards · ${cip.engineering_standards.code_review_criterion_count} code review criteria · ${cip.engineering_standards.testing_standard_count} testing standards · ${cip.engineering_standards.mc_engineering_dashboard_metric_count} engineering dashboard metrics · ${cip.engineering_standards.packages_complete_pct}% complete (${cip.engineering_standards.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Engineering constitution:</strong> code for the next volunteer · PR standards · branch strategy · architectural guardrails · dependency review · technical debt visibility</p>
    <p class="mc-bar-note"><a href="${cip.engineering_standards.route}">IMPLEMENTATION_PACKAGE_33_ENGINEERING_STANDARDS.md</a> · <a href="${cip.engineering_standards.manifest}">engineering-standards-manifest.json</a> · <a href="${cip.engineering_standards.mc_dashboard}">Repository governance dashboard</a></p>
    <p class="mc-bar-note">${cip.engineering_standards.philosophy}</p>
    <h2 class="mc-section-title">Implementation Roadmap (IMP-32)</h2>
    <p class="mc-bar-note"><strong>${cip.implementation_roadmap.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.implementation_roadmap.development_wave_count} development waves · ${cip.implementation_roadmap.validation_gate_count} validation gates · ${cip.implementation_roadmap.engineering_dependency_rule_count} dependency rules · ${cip.implementation_roadmap.july_11_delivery_count} July 11 deliverables · ${cip.implementation_roadmap.engineering_dashboard_item_count} engineering dashboard items · ${cip.implementation_roadmap.packages_complete_pct}% complete (${cip.implementation_roadmap.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Cursor execution:</strong> Foundation → Institutional Core → Education → Community → Intelligence → Public → Ops Readiness → Launch · dependency order, never build randomly</p>
    <p class="mc-bar-note"><a href="${cip.implementation_roadmap.route}">IMPLEMENTATION_PACKAGE_32_IMPLEMENTATION_ROADMAP.md</a> · <a href="${cip.implementation_roadmap.manifest}">implementation-roadmap-manifest.json</a> · <a href="${cip.implementation_roadmap.mc_dashboard}">Engineering dashboard</a></p>
    <p class="mc-bar-note">${cip.implementation_roadmap.philosophy}</p>
    <h2 class="mc-section-title">AI Orchestration (IMP-31)</h2>
    <p class="mc-bar-note"><strong>${cip.ai_orchestration.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.ai_orchestration.ai_architecture_layer_count} AI architecture layers · ${cip.ai_orchestration.department_localbrain_count} department LocalBrains · ${cip.ai_orchestration.specialized_agent_total_count} specialized agents · ${cip.ai_orchestration.ai_ethics_principle_count} ethics principles · ${cip.ai_orchestration.mc_ai_dashboard_metric_count} AI dashboard metrics · ${cip.ai_orchestration.packages_complete_pct}% complete (${cip.ai_orchestration.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Human-led, AI-assisted:</strong> Executive AI → LocalBrains → specialized agents → Personal AI → workflow automation · Oct 1 AI supports all 75 counties</p>
    <p class="mc-bar-note"><a href="${cip.ai_orchestration.route}">IMPLEMENTATION_PACKAGE_31_AI_ORCHESTRATION.md</a> · <a href="${cip.ai_orchestration.manifest}">ai-orchestration-manifest.json</a> · <a href="${cip.ai_orchestration.mc_dashboard}">Institutional AI dashboard</a></p>
    <p class="mc-bar-note">${cip.ai_orchestration.philosophy}</p>
    <h2 class="mc-section-title">Launch Strategy (IMP-30) — 60% Milestone</h2>
    <p class="mc-bar-note"><strong>${cip.launch_strategy.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.launch_strategy.launch_phase_count} launch phases · ${cip.launch_strategy.county_launch_framework_count} county launch steps · ${cip.launch_strategy.statewide_readiness_certification_count} readiness certification items · ${cip.launch_strategy.launch_success_metric_count} success metrics · ${cip.launch_strategy.launch_celebration_milestone_count} celebration milestones · ${cip.launch_strategy.packages_complete_pct}% complete (${cip.launch_strategy.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Four-phase rollout:</strong> Software Complete (Jul 11) → County Expansion (Oct 1) → Community Growth (Dec) → Institutional Readiness (Jan 2027) · adoption over publicity</p>
    <p class="mc-bar-note"><a href="${cip.launch_strategy.route}">IMPLEMENTATION_PACKAGE_30_LAUNCH_STRATEGY.md</a> · <a href="${cip.launch_strategy.manifest}">launch-strategy-manifest.json</a> · <a href="${cip.launch_strategy.mc_dashboard}">Launch Strategy dashboard</a></p>
    <p class="mc-bar-note">${cip.launch_strategy.philosophy}</p>
    <h2 class="mc-section-title">Sustainability & Continuity (IMP-29)</h2>
    <p class="mc-bar-note"><strong>${cip.sustainability_continuity.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.sustainability_continuity.continuity_pillar_count} continuity pillars · ${cip.sustainability_continuity.institutional_playbook_count} institutional playbooks · ${cip.sustainability_continuity.succession_planning_tracking_count} succession tracking areas · ${cip.sustainability_continuity.institutional_memory_preserve_count} memory preserves · ${cip.sustainability_continuity.mc_sustainability_dashboard_metric_count} sustainability metrics · ${cip.sustainability_continuity.packages_complete_pct}% complete (${cip.sustainability_continuity.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 sustainability goal:</strong> documented procedures · shared resources · county knowledge repository · volunteer onboarding · leadership continuity — resilient at the local level</p>
    <p class="mc-bar-note"><a href="${cip.sustainability_continuity.route}">IMPLEMENTATION_PACKAGE_29_SUSTAINABILITY_CONTINUITY.md</a> · <a href="${cip.sustainability_continuity.manifest}">sustainability-continuity-manifest.json</a> · <a href="${cip.sustainability_continuity.mc_dashboard}">Sustainability dashboard</a></p>
    <p class="mc-bar-note">${cip.sustainability_continuity.philosophy}</p>
    <h2 class="mc-section-title">Governance & PMO (IMP-28)</h2>
    <p class="mc-bar-note"><strong>${cip.governance_pmo.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.governance_pmo.institutional_structure_level_count} structure levels · ${cip.governance_pmo.pmo_responsibility_count} PMO responsibilities · ${cip.governance_pmo.decision_framework_step_count} decision steps · ${cip.governance_pmo.governance_meeting_type_count} governance meeting types · ${cip.governance_pmo.risk_governance_category_count} risk categories · ${cip.governance_pmo.packages_complete_pct}% complete (${cip.governance_pmo.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 governance goal:</strong> 75 county leadership teams · organizational partnerships · Education Leader coordination · volunteer oversight · Mission Control reporting · statewide operational consistency</p>
    <p class="mc-bar-note"><a href="${cip.governance_pmo.route}">IMPLEMENTATION_PACKAGE_28_GOVERNANCE_PMO.md</a> · <a href="${cip.governance_pmo.manifest}">governance-pmo-manifest.json</a> · <a href="${cip.governance_pmo.mc_dashboard}">Governance dashboard</a></p>
    <p class="mc-bar-note">${cip.governance_pmo.philosophy}</p>
    <h2 class="mc-section-title">DevOps & Production Operations (IMP-27)</h2>
    <p class="mc-bar-note"><strong>${cip.devops_production.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.devops_production.infrastructure_component_count} infrastructure components · ${cip.devops_production.deployment_pipeline_step_count} deployment pipeline steps · ${cip.devops_production.environment_count} environments · ${cip.devops_production.monitoring_platform_metric_count} monitoring metrics · ${cip.devops_production.operational_metric_count} operational metrics · ${cip.devops_production.packages_complete_pct}% complete (${cip.devops_production.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 production goal:</strong> 75 county OS · organization portals · academy · volunteer network · Mission Control · knowledge platform · community conversations · public website — infrastructure never limits growth</p>
    <p class="mc-bar-note"><a href="${cip.devops_production.route}">IMPLEMENTATION_PACKAGE_27_DEVOPS_PRODUCTION.md</a> · <a href="${cip.devops_production.manifest}">devops-production-manifest.json</a> · <a href="${cip.devops_production.mc_dashboard}">Platform Operations dashboard</a></p>
    <p class="mc-bar-note">${cip.devops_production.philosophy}</p>
    <h2 class="mc-section-title">QA & Launch Readiness (IMP-26)</h2>
    <p class="mc-bar-note"><strong>${cip.qa_launch_readiness.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.qa_launch_readiness.launch_certification_module_count} launch certification modules · ${cip.qa_launch_readiness.county_readiness_criteria_count} county readiness criteria · ${cip.qa_launch_readiness.statewide_launch_checklist_count} launch checklist items · ${cip.qa_launch_readiness.counties_with_partnerships_goal} counties with partnerships goal · ${cip.qa_launch_readiness.operational_simulation_count} operational simulations · ${cip.qa_launch_readiness.packages_complete_pct}% complete (${cip.qa_launch_readiness.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 priority:</strong> 75 counties operational · 75 counties with active organizational partners · Education Leaders · volunteer pipeline · academy · Mission Control reporting</p>
    <p class="mc-bar-note"><a href="${cip.qa_launch_readiness.route}">IMPLEMENTATION_PACKAGE_26_QA_LAUNCH_READINESS.md</a> · <a href="${cip.qa_launch_readiness.manifest}">qa-launch-readiness-manifest.json</a> · <a href="${cip.qa_launch_readiness.mc_dashboard}">Launch Certification dashboard</a></p>
    <p class="mc-bar-note">${cip.qa_launch_readiness.philosophy}</p>
    <h2 class="mc-section-title">Security & Trust (IMP-25) — 50% Milestone</h2>
    <p class="mc-bar-note"><strong>${cip.security_trust.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.security_trust.security_principle_count} security principles · ${cip.security_trust.data_classification_count} data classification levels · ${cip.security_trust.compliance_area_count} compliance areas · ${cip.security_trust.audit_event_count} audit event types · ${cip.security_trust.ethics_standard_count} ethics standards · ${cip.security_trust.packages_complete_pct}% complete (${cip.security_trust.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Halfway point:</strong> 25 of 50 implementation packages documented — trust framework, privacy, DR, AI governance, incident response</p>
    <p class="mc-bar-note"><a href="${cip.security_trust.route}">IMPLEMENTATION_PACKAGE_25_SECURITY_TRUST.md</a> · <a href="${cip.security_trust.manifest}">security-trust-manifest.json</a> · <a href="${cip.security_trust.mc_dashboard}">Trust Framework dashboard</a></p>
    <p class="mc-bar-note">${cip.security_trust.philosophy}</p>
    <h2 class="mc-section-title">Integration Platform (IMP-24)</h2>
    <p class="mc-bar-note"><strong>${cip.integration_platform.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.integration_platform.integration_category_count} integration categories · ${cip.integration_platform.integration_pipeline_step_count} pipeline steps · ${cip.integration_platform.open_api_use_case_count} open API use cases · ${cip.integration_platform.institutional_event_count} institutional events · ${cip.integration_platform.integration_security_standard_count} security standards · ${cip.integration_platform.packages_complete_pct}% complete (${cip.integration_platform.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 readiness:</strong> calendar sync · email · video meetings · mapping · AI gateway · public data · secure APIs — institution owns data, external services provide capabilities</p>
    <p class="mc-bar-note"><a href="${cip.integration_platform.route}">IMPLEMENTATION_PACKAGE_24_INTEGRATION_PLATFORM.md</a> · <a href="${cip.integration_platform.manifest}">integration-platform-manifest.json</a> · <a href="${cip.integration_platform.mc_dashboard}">Systems Integration dashboard</a></p>
    <p class="mc-bar-note">${cip.integration_platform.philosophy}</p>
    <h2 class="mc-section-title">Digital Library (IMP-23)</h2>
    <p class="mc-bar-note"><strong>${cip.digital_library.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.digital_library.collection_count} library collections · ${cip.digital_library.metadata_field_count} metadata fields · ${cip.digital_library.lifecycle_stage_count} lifecycle stages · ${cip.digital_library.search_dimension_count} search dimensions · ${cip.digital_library.document_access_level_count} access levels · ${cip.digital_library.packages_complete_pct}% complete (${cip.digital_library.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 library goal:</strong> foundational county digital library — profile, resources, contacts, organizations, presentation materials, conversation toolkit</p>
    <p class="mc-bar-note"><a href="${cip.digital_library.route}">IMPLEMENTATION_PACKAGE_23_DIGITAL_LIBRARY.md</a> · <a href="${cip.digital_library.manifest}">digital-library-manifest.json</a> · <a href="${cip.digital_library.mc_dashboard}">Research Library dashboard</a></p>
    <p class="mc-bar-note">${cip.digital_library.philosophy}</p>
    <h2 class="mc-section-title">Mobile PWA & Field Operations (IMP-22)</h2>
    <p class="mc-bar-note"><strong>${cip.mobile_pwa.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.mobile_pwa.pwa_capability_count} PWA capabilities · ${cip.mobile_pwa.mobile_dashboard_widget_count} dashboard widgets · ${cip.mobile_pwa.qr_code_target_count} QR targets · ${cip.mobile_pwa.field_data_collection_count} field data types · ${cip.mobile_pwa.mobile_accessibility_count} accessibility features · ${cip.mobile_pwa.packages_complete_pct}% complete (${cip.mobile_pwa.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Field-first:</strong> offline cache · event check-in · Education Leader toolkit · mobile AI · travel support — institution travels with volunteers</p>
    <p class="mc-bar-note"><a href="${cip.mobile_pwa.route}">IMPLEMENTATION_PACKAGE_22_MOBILE_PWA.md</a> · <a href="${cip.mobile_pwa.manifest}">mobile-pwa-manifest.json</a> · <a href="${cip.mobile_pwa.mc_dashboard}">Outreach dashboard</a></p>
    <p class="mc-bar-note">${cip.mobile_pwa.philosophy}</p>
    <h2 class="mc-section-title">Public Website (IMP-21)</h2>
    <p class="mc-bar-note"><strong>${cip.public_website.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.public_website.homepage_section_count} homepage sections · ${cip.public_website.arkansas_map_layer_count} map layers · ${cip.public_website.begin_learning_entry_count} learning entry points · ${cip.public_website.public_engagement_action_count} engagement actions · ${cip.public_website.accessibility_standard_count} accessibility standards · ${cip.public_website.packages_complete_pct}% complete (${cip.public_website.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Digital front door:</strong> Why care · What learn · What next — on every page · <a href="${cip.public_website.public_site_url}">Live homepage</a></p>
    <p class="mc-bar-note"><a href="${cip.public_website.route}">IMPLEMENTATION_PACKAGE_21_PUBLIC_WEBSITE.md</a> · <a href="${cip.public_website.manifest}">public-website-manifest.json</a> · <a href="${cip.public_website.mc_dashboard}">Visitor Journey dashboard</a></p>
    <p class="mc-bar-note">${cip.public_website.philosophy}</p>
    <h2 class="mc-section-title">Automation Engine (IMP-20)</h2>
    <p class="mc-bar-note"><strong>${cip.automation_engine.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.automation_engine.workflow_engine_step_count} workflow steps · ${cip.automation_engine.workflow_category_count} workflow categories · ${cip.automation_engine.workflow_type_count} workflow types · ${cip.automation_engine.approval_rule_count} approval rules · ${cip.automation_engine.automation_rule_count} automation rules · ${cip.automation_engine.packages_complete_pct}% complete (${cip.automation_engine.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>40% blueprint milestone:</strong> statewide civic education operating system architecture — automation returns time to volunteers for research, education, and community work</p>
    <p class="mc-bar-note"><a href="${cip.automation_engine.route}">IMPLEMENTATION_PACKAGE_20_AUTOMATION_ENGINE.md</a> · <a href="${cip.automation_engine.manifest}">automation-engine-manifest.json</a> · <a href="${cip.automation_engine.mc_dashboard}">PMO Execution Office</a></p>
    <p class="mc-bar-note">${cip.automation_engine.philosophy}</p>
    <h2 class="mc-section-title">Institutional Analytics (IMP-19)</h2>
    <p class="mc-bar-note"><strong>${cip.institutional_analytics.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.institutional_analytics.intelligence_layer_count} intelligence layers · ${cip.institutional_analytics.executive_scorecard_count} executive scorecards · ${cip.institutional_analytics.community_health_indicator_count} community health indicators · ${cip.institutional_analytics.institutional_health_component_count} institutional health components · ${cip.institutional_analytics.predictive_analytics_count} predictive models · ${cip.institutional_analytics.packages_complete_pct}% complete (${cip.institutional_analytics.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Goal tracking:</strong> Jul 11 software · Oct 1 75 counties · 250 cities · ${cip.institutional_analytics.engagement_goal_pct}% engagement · ${cip.institutional_analytics.arkansans_connected_goal.toLocaleString()} Arkansans connected · Jan 2027 readiness</p>
    <p class="mc-bar-note"><a href="${cip.institutional_analytics.route}">IMPLEMENTATION_PACKAGE_19_INSTITUTIONAL_ANALYTICS.md</a> · <a href="${cip.institutional_analytics.manifest}">institutional-analytics-manifest.json</a> · <a href="${cip.institutional_analytics.mc_dashboard}">Impact Measurement dashboard</a></p>
    <p class="mc-bar-note">${cip.institutional_analytics.philosophy}</p>
    <h2 class="mc-section-title">Relationship Intelligence (IMP-18)</h2>
    <p class="mc-bar-note"><strong>${cip.relationship_intelligence.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.relationship_intelligence.relationship_architecture_type_count} relationship types · ${cip.relationship_intelligence.contact_profile_field_count} contact profile fields · ${cip.relationship_intelligence.community_graph_visualization_count} community graph views · ${cip.relationship_intelligence.relationship_health_metric_count} health metrics · ${cip.relationship_intelligence.packages_complete_pct}% complete (${cip.relationship_intelligence.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Oct 1 goal:</strong> identifiable relationship network in every county — Education Leaders, coalition orgs, volunteers, conversations, local contacts, mentorship pathways</p>
    <p class="mc-bar-note"><a href="${cip.relationship_intelligence.route}">IMPLEMENTATION_PACKAGE_18_RELATIONSHIP_INTELLIGENCE.md</a> · <a href="${cip.relationship_intelligence.manifest}">relationship-intelligence-manifest.json</a> · <a href="${cip.relationship_intelligence.mc_dashboard}">Contact Intelligence dashboard</a></p>
    <p class="mc-bar-note">${cip.relationship_intelligence.philosophy}</p>
    ...
    <p class="mc-bar-note"><a href="${cip.communication_platform.route}">IMPLEMENTATION_PACKAGE_16_COMMUNICATION_PLATFORM.md</a> · <a href="${cip.communication_platform.manifest}">communication-platform-manifest.json</a> · <a href="/mission-control/arkansas-communications.html">Communications dashboard</a></p>
    <p class="mc-bar-note">${cip.communication_platform.philosophy}</p>
    <h2 class="mc-section-title">Local Operating Systems (IMP-15)</h2>
    <p class="mc-bar-note"><strong>${cip.local_operating_systems.status === 'documented' ? 'Documented' : 'Pending'}</strong> · ${cip.local_operating_systems.counties_total} counties · ${cip.local_operating_systems.target_cities} cities · ${cip.local_operating_systems.county_module_count} county modules · ${cip.local_operating_systems.city_module_count} city modules · ${cip.local_operating_systems.neighborhood_module_count} neighborhood modules · ${cip.local_operating_systems.packages_complete_pct}% complete (${cip.local_operating_systems.packages_completed}/50)</p>
    <p class="mc-bar-note"><strong>Engagement goal:</strong> ${cip.local_operating_systems.engagement_goal_pct}% registered voters connected per county and target city · <strong>Oct 1:</strong> live county OS in all ${cip.local_operating_systems.counties_total} counties</p>
    <p class="mc-bar-note"><a href="${cip.local_operating_systems.route}">IMPLEMENTATION_PACKAGE_15_LOCAL_OPERATING_SYSTEMS.md</a> · <a href="${cip.local_operating_systems.manifest}">local-operating-systems-manifest.json</a> · <a href="/mission-control/county-os.html">County OS dashboard</a></p>
    <p class="mc-bar-note">${cip.local_operating_systems.philosophy}</p>
    ...
    <p class="mc-bar-note"><a href="${cip.volunteer_network.route}">IMPLEMENTATION_PACKAGE_13_VOLUNTEER_NETWORK.md</a> · <a href="${cip.volunteer_network.manifest}">volunteer-network-manifest.json</a> · <a href="/mission-control/outreach.html">Outreach dashboard</a></p>
    <p class="mc-bar-note">${cip.volunteer_network.philosophy}</p>
    ...
    <h3 class="mc-subsection-title">Repository Layers</h3>
    <ul class="mc-deliverables">${cip.technical_architecture.repository_layers.map(l => `<li><code>${l}/</code></li>`).join('')}</ul>
